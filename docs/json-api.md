...
To access the generated identfier:

```javascript
const sheet = jss.createStyleSheet(styles)

sheet.getRule('my-animation').id // my-animation-976495528
```

#### CSS

Keyframe identifier is generated by default.

```css
@keyframes my-animation-976495528 {
  from { opacity: 0; }
  to { opacity: 1; }
}
```
